...
import (
	...
	"github.com/avsolatorio/datacommons-mixer/internal/server/recon"
	"github.com/avsolatorio/datacommons-mixer/internal/server/statvar/hierarchy"
	"github.com/avsolatorio/datacommons-mixer/internal/server/statvar/search"
	"github.com/avsolatorio/datacommons-mixer/internal/server/translator"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/event"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/info"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/observationdates"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/observationexistence"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/observations"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/page"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/properties"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/propertyvalues"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/triples"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/variable"
	"github.com/avsolatorio/datacommons-mixer/internal/server/v1/variables"
